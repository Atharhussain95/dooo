...
document.addEventListener("DOMContentLoaded", function() {
    page2();
    page3(); 
    page4(); // Move page4 call here to ensure it runs after page2 and page3
});
...
function page4() {
    ...
    const scrollAnimation = gsap.to(".page4", {
        scrollTrigger: {
            trigger: ".page4",
            start: "top top", // Start when the top of page4 hits the top of the viewport
    ...
    // Heading Animation
    // Add your heading animation code here

    // Paragraph Animation
    gsap.from(".abu", {
        opacity: 0,
        x: -50,
        duration: 0.75, // Reduced duration for quicker reveal
    ...
    gsap.from(".solution-btn", {
        ...
        // Remove the onComplete callback
    });

    // Add additional GSAP animations here as needed
    // Call page5 to initialize the scrollTrigger for page5 animations
    page5(); 
}
...
function page5() {
    ...
    // Select all text elements for animation
    const textElements = document.querySelectorAll('#page5 span');
        ...
        gsap.fromTo(element, 
            ...
            { 
                ...
                scrollTrigger: {
                    ...
                    start: "top 90%", // Trigger animation when the top of the element is 80% from the top of the viewport
                    toggleActions: "play none none reverse", // Play animation when entering, reverse on exit
